...
UPLOAD_FOLDER = r'C:\Users\suhas\Desktop\food_classification\Food-Image-Recognition-master\Food-Image-Recognition-master\static\uploads'
...
with open(r'C:\Users\suhas\Desktop\food_classification\Food-Image-Recognition-master\Food-Image-Recognition-master\nutrition101.csv', 'r') as file:
...
@app.route('/')
def index():
    img = 'Food-Image-Recognition-master/Food-Image-Recognition-master/static/profile.jpg'
...
def index():
    img = url_for('static', filename=r'C:\Users\suhas\Desktop\food recog\static\profile.jpg')  # Ensure this path is correct
    return render_template('index.html', img=img)
